 ...
 */
class JiraConnector(private val project: Project) {
    ...
    companion object {
        ...
        fun getInstance(project: Project): JiraConnector {
            return ServiceManager.getService(project, JiraConnector::class.java)
     ...
     */
    fun configure(baseUrl: String, apiToken: String, email: String, projectKey: String) {
    ...
    fun isConfigured(): Boolean {
        return baseUrl.isNotEmpty() && apiToken.isNotEmpty() && 
     ...
     */
    fun searchIssues(jql: String, maxResults: Int = 50): List<JiraIssue> {
     ...
     * Update issue fields
     */
    fun updateIssue(issueKey: String, fields: Map<String, Any>): Boolean {
        if (!isConfigured()) return false
     ...
     */
    private fun createPostRequest(url: String, body: Any): HttpRequest {
     ...
     */
    private fun createPutRequest(url: String, body: Any): HttpRequest {
        val json = gson.toJson(body)
        return HttpRequest.newBuilder()
            .uri(URI.create(url))
